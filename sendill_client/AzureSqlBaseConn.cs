...
{
    public class AzureSqlBaseConn
    {
        public static string DbProperties
        {
            //get { return @"Data Source=localhost;Initial Catalog=Sendill;Integrated Security=True"; }
            get { return @"Data Source=srvsendill.database.windows.net; Initial Catalog=dbsendill; Integrated Security=False; User ID=dbadmin; Password=#audkenni1912; Connect Timeout=60; Encrypt=False; TrustServerCertificate=False"; }
